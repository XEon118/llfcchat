...
private:
	...
	bool GetFriendApplyInfo(int to_uid, std::vector<std::shared_ptr<ApplyInfo>>& list);	//拉取好友申请
	bool GetFriendList(int self_id, std::vector<std::shared_ptr<UserInfo>>& user_list);	//拉取好友列表
